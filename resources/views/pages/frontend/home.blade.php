                    ...
                    @forelse ($packages as $package)
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div
                                ...
                                style="
                                    background-image: url('{{ $package->first_image }}');
                                "
                            >
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 text-center">
                        <img
                            src="{{ asset('frontend/images/logos_partner.png') }}"
                            alt="Logo Partner"
                            class="img-partner"
                        />
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img
                                    src="{{ asset('frontend/images/testimonial-1.png') }}"
                                    alt="User"
                                    class="mb-4 rounded-circle"
                                />
                                <h3 class="mb-4">Austin Distel</h3>
                                <p class="testimonial">
